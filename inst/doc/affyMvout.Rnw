...
%\VignetteIndexEntry{affyMvout -- multivariate outlier algorithm for affymetrix QA}
%\VignetteDepends{}
%\VignetteKeywords{Expression Analysis}
%\VignettePackage{affyMvout}
...
The affyMvout package computes $Q$
...
By default we have a type I error rate of 0.05.

<<doao>>=
AO = ArrayOutliers(afxsub, qcOut=afxsubQC, 
...
<<doaaaasdas,cache=TRUE>>=
aos12c = ArrayOutliers(s12c)
<<lkres>>=
aos12c[[1]]
@
